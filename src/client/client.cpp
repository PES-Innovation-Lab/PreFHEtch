...
int main() {
    ...
    SPDLOG_INFO("Received encrypted coarse distances successfully, time(microseconds) = {}", coarse_search_timer.getDurationMicroseconds());
    ...
    SPDLOG_INFO("Deserialised and decrypted coarse distances successfully, time(microseconds) = {}", deserialise_coarse_search_results_timer.getDurationMicroseconds());
    ...
    SPDLOG_INFO("Computed nearest coarse vectors successfully, time(microseconds) = {}", compute_nearest_nprobe_coarse_search_timer.getDurationMicroseconds());
